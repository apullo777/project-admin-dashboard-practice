...
/* Module 
const Exercise = ((name, desc, link, type) => {
    const create = () => {
...
const pigLatin = Exercise(
    'Simple Pig Latin',
    'Move the first letter of each word to the end of it, then add "ay" to the end of the word.',
    'https://github.com/apullo777/codewars-solutions/blob/main/5kyu/simplePigLatin.js',
    'codewar'
);

const strIncrementer = Exercise(
    'String Incremeter',
    'writing a function which increments a string, to create a new string',
    'https://github.com/apullo777/codewars-solutions/blob/main/5kyu/strIncrementer.js',
    'codewar'
)
